...
)
{
	...
	do
	{
		...
		if (numOpened == 0) { UE_LOG(LogTemp, Warning, TEXT("Did not find a path"));; return -1; }
		...
		for (int i = 0; i < numtransitions; ++i)
		{
			...
			if (numOpened == MAXOPEN) { UE_LOG(LogTemp, Warning, TEXT("overflow")); return -1; } // ran out of storage for opened set
		}
	} while (true);
